...
#     who?? Username=hardc0d3@github_
#        url? https://github.com/hardc0d3?tab=repositories
#
...
def random_unicode(N):
    return unicode(''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(N)))
